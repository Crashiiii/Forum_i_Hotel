...
<article>
  <div class="sendreport">
        <form action="/" id="FormZgl">
        <label for="message">Zgłoś swój problem</label>
        <textarea name="contents" id="contents" placeholder="Wpisz swoją wiadomość" required></textarea>
